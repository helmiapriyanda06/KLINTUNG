...
import com.helmi_18104036.klintung.data.DataMerger
import com.helmi_18104036.klintung.data.DataWisata.listData

class Horizontal_RecyclerView(val context: Context) :
    RecyclerView.Adapter<Horizontal_RecyclerView.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        Log.d("TAG", "${DataMerger.getData().size}")
        val listData = DataMerger.getData()
    ...
    override fun getItemCount(): Int {
        return DataMerger.getData().size
    }
